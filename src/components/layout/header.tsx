...
import { Home, Info, Menu, X, UserPlus, HandHelping } from "lucide-react";
...
import Logo from "@public/header/identidad-corporativa.png";
...
const navItems: NavItem[] = [
  ...
  {
    href: "/unete/voluntario",
    label: "Únete",
    icon: UserPlus,
    baseRoute: "/unete",
  },
  {
    href: "/apoya/donaciones",
    label: "Apoya",
    icon: HandHelping,
    baseRoute: "/apoya",
  },
...
const LogoOrg: JSX.Element = (
  <Image src={Logo} height={80} width={160} alt={APP_NAME} />
);
