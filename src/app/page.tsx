    ...
    <div className="space-y-12 md:space-y-16">
      ...
      <section className="py-12 md:py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-semibold text-foreground sm:text-4xl">¿Cómo Ayudamos?</h2>
          <p className="mt-4 text-lg text-muted-foreground">Descubre las formas en que generamos un impacto positivo.</p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {HOME_PAGE_CONTENT.features.map((feature) => {
            const IconComponent = iconMap[feature.icon];
            return (
              <Card key={feature.title} className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg">
      ...
      <section className="py-12 md:py-16 bg-secondary/50 rounded-xl shadow-md">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" asChild className="mt-8 shadow-md hover:shadow-lg transition-shadow">
            <Link href="/donate">
              Contribuir Ahora
